	...
	public static void main(String[] args) {
		...
		Connection conn = null;
		   ...
		   try{
		      ...
		      String sql;
		      sql = "select * from mybank.transfer";
		      ...
		      while(rs.next()){
		         //Retrieve by column name
		    	  ...
		    	  String TransferDescription = rs.getString("TransferDescription");
		         ...
		         System.out.print(", TransferDescription: " + TransferDescription);
		         System.out.print(", fromaccount: " + fromaccount);
		         System.out.print(", ToAccount: " + ToAccount);
